...
def convert_episode_container_to_mat(epc):
    times = [datetime2matlabdn(datetime(2000,1,1,0,0,0)+timedelta(minutes=i)) for i in range(len(epc.load_ts))]
    return build_dict_mat_file(epc.load_ts, epc.pv_ts, times)
